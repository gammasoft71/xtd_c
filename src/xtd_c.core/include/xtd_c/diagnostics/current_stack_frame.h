...
struct xtd_current_stack_frame {
  char file_name[__CURRENT_STACK_FRAME_FILE_NAME__];
  uint32_t file_line_number;
  char method_name[__CURRENT_STACK_FRAME_METHOD_NAME__];
...
(xtd_current_stack_frame_create_from_file_line_func(__FILE__, __LINE__, __func__))
...
/** @{ */
/**
 @brief Initializes a new instance of the xtd_current_stack_frame with default settings.
...
/**
 ...
 @ingroup xtd_c stack_frame
 */
void xtd_current_stack_frame_destroy(xtd_current_stack_frame* value);
/** @} */
