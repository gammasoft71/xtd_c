...
/**
 ...
 @param owner An xtd_control that will own the modal dialog box.
 @param text The text to display in the message box.
 @param caption The text to display in the title bar of the message box.
 @param buttons One of the xtd_message_box_buttons values that specifies which buttons to display in the message box.
 @param icon One of the xtd_message_box_icon values that specifies which icon to display in the message box.
 @param default_button One of the xtd_message_box_default_button values that specifies the default button for the message box.
 @param options One of the xtd_message_box_options values that specifies which display and association options will be used for the message box. You may pass in 0 if you wish to use the defaults.
 @param display_help_button true to show the Help button; otherwise, false. The default is false.
 @return One of the xtd_dialog_result values.
 @par Library
 xtd_c.forms
